...
require (
	apppathway.com/examples/prodapi/pkg/plugins/intent/api/intentpb v0.0.0-00010101000000-000000000000
	apppathway.com/pkg/errors v0.0.0-00010101000000-000000000000
