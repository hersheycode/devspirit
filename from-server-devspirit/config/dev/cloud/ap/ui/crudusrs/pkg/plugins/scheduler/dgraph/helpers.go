...
func (s *SchedulerService) mutate(ctx context.Context, data any) (string, error) {
...
func (s *SchedulerService) query(ctx context.Context, query string, vars map[string]string, result any) error {
...
func upsert[T any](ctx context.Context, s *SchedulerService, query string, mu ...*api.Mutation) ([]T, error) {
	request := &api.Request{
		Query:     query,
		Mutations: mu,
		CommitNow: true,
