...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "dsn", "trevor:secret@tcp(mysql:3306)/widgets?parseTime=true&tls=false", "DSN")
	flag.StringVar(&cfg.api, "api", "", "URL to api")
	flag.StringVar(&cfg.secretkey, "secret", "bRWmrwNUTqNUuzckjxsFlHZjxHkjrzKP", "secret key")
	flag.StringVar(&cfg.frontend, "frontend", "", "url to front end")
