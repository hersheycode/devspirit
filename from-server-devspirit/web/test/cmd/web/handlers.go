...
func (app *application) Requests(w http.ResponseWriter, r *http.Request) {
	...
	if err := app.renderTemplate(w, r, "req", &templateData{
		Data: data,
	}); err != nil {
		app.errorLog.Print(err)
	}
...
func (app *application) Generated(w http.ResponseWriter, r *http.Request) {
	widget, err := app.DB.GetWidget(2)
	if err != nil {
		app.errorLog.Println(err)
		return
	...
	if err := app.renderTemplate(w, r, "gen", &templateData{
		Data: data,
	}); err != nil {
		app.errorLog.Print(err)
	}
...
func (app *application) Builder(w http.ResponseWriter, r *http.Request) {
	widget, err := app.DB.GetWidget(2)
	if err != nil {
		app.errorLog.Println(err)
		return
	...
	if err := app.renderTemplate(w, r, "build", &templateData{
		Data: data,
	}); err != nil {
		app.errorLog.Print(err)
	}
