...
var turnCmd = &cobra.Command{
	...
	Long: `app turn "func CreateContainer" -into rpc -save_to myplugin  
    # turns CreateContainer into an rpc 
	# integrates rpc into default 
	# commits container to a new image called myplugin; caches myplugin as current`,
