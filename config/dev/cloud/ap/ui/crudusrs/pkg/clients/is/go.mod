...
replace codestore.localhost/crudusrs/crud_basic/api/crudbasic/api/intentpb => /workspaces/devspirit/config/dev/cloud/ap/ui/crususrs/pkg/plugins/intent/api/intentpb
